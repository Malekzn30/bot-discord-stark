...
class BotManagement(commands.Cog):
    ...
    @commands.command()
    @commands.is_owner()
    async def autoreact(self, ctx, channel: nextcord.TextChannel = None, *emojis):
    ...
    @commands.command()
    @commands.is_owner()
    async def stopautoreact(self, ctx, channel: nextcord.TextChannel = None):
    ...
    @commands.command()
    @commands.is_owner()
    async def setactivity(self, ctx, *, activity: str = None):
